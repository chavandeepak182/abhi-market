            ...
            <table id="studentTable" class="table table-striped">
                ...
                <tbody id="user_table_body">
                    ...
                    <tr>
                        ...
                        <td><span class="fw-medium text-gray-300">{{ $contact->id }}</span></td>
                        <td><span class="fw-medium text-gray-300">{{ $contact->name }}</span></td>
                        <td><span class="fw-medium text-gray-300">{{ $contact->email }}</span></td>
                        <td><span class="fw-medium text-gray-300">{{ $contact->contact }}</span></td>

                        <!-- If you want to show page_url instead, uncomment below -->
                        <!--
                        <td>
                            <a href="{{ $contact->page_url }}" target="_blank" class="fw-medium text-primary">
                                {{ Str::limit($contact->page_url, 50) }}
                            </a>
                        </td>
                        -->
