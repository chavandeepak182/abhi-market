            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque">Insights</h1>
        ...
        <div class="container">
            <div class="row">
                @foreach($allInsights as $insight)
                    <?php 
                        $img = env('baseURL'). "/" . $insight->image;
                        $insightName = $insight->insights_name;
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="service-item wow fadeInUp">
                            <div class="icon-box">
                                <img src="{{ $img }}" alt="{{ $insightName }}">
                            </div>

                            <div class="service-item-content">
                                <h3>{{ $insightName }}</h3>
                                <p>{{ Str::limit(strip_tags($description), 150) }}</p>
                                <a href="{{ route('insights.details', ['slug' => $insight->slug]) }}" class="service-btn">
