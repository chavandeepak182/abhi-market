                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('subcategories.delete', $subcategory->property_subcategory_id) }}" class="btn btn-danger" onclick="return confirm('Are you sure?');"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
