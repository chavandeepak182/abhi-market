                ...
                <tbody id="user_table_body">
                   ...
                   <tr class="{{ $lead->status == 'new' ? 'new-lead-row' : '' }}">
                       ...
                       <td>
                        ...
                        <td><span class="fw-medium text-gray-300">{{ $lead->job_title }}</span></td>
                        ...
                        <td><span class="fw-medium text-gray-300">{{ $lead->page_name }}</span></td>
                        <!-- <td><span class="fw-medium text-gray-300">{{ $lead->message }}</span></td> -->
                        <!-- <td>
                                    <a href="{{ $lead->page_url }}" target="_blank" class="fw-medium text-primary">
                                {{ Str::limit($lead->page_url, 50) }}
                            </a>
                        </td> -->
                        <td>
