                ...
                <div class="auth-right__inner mx-auto w-100">
                    ...
                    <form action="#">
                        ...
                        <div class="mb-32 flex-between flex-wrap gap-8">
                            ...
                            <a href="{{ asset('dashboard') }}/assetsforgot-password.html" class="text-main-600 hover-text-decoration-underline text-15 fw-medium">Forgot Password?</a>
                        </div>
                        ...
                        <p class="mt-32 text-gray-600 text-center">New on our platform?
                            <a href="{{ url('/sign-up') }}" class="text-main-600 hover-text-decoration-underline">Create an account</a>
                        </p>                        
                    </form>
                </div>
            </div>
