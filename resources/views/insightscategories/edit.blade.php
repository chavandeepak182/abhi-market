        ...
        <div class="card-body">
            ...
            <div class="row gy-20">
                <div class="col-md-5 col-sm-5">
                    <form action="{{ route('insights.categories.update', $category->pid) }}" method="POST">
                        @csrf
                        <div class="mb-20">
                        ...
                        <div class="flex-align mt-10">
                            ...
                            <a href="{{ route('insights.categories.index') }}" class="btn btn-secondary rounded-pill py-9 ms-10">Back</a>
                        </div>
                    </form>
                </div>
            </div>
