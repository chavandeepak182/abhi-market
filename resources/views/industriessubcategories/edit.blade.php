        ...
        <div class="card-body">
            ...
            <div class="row gy-20">
                <div class="col-md-5 col-sm-5">
                    <form action="{{ route('industries.subcategories.update', $subcategory->industries_subcategory_id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <a href="{{ route('industries.subcategories.index') }}" class="btn btn-secondary rounded-pill py-9 ms-10">Back</a>
                    </form>
                </div>
            </div>
        </div>
